...
<body>
  ...
  <header id="header">
    ...
    <!-- <h1>MINILEMON: SHARE OF LIFE</h1>
     <h3>FORUM BERCERITA UNTUK ANAK</h3> -->
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="<?php echo base_url().'assets/images/bacabuku.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Share Of Life</h2>
		   					<h3><p>Tulis ceritamu sekarang! </p></h3>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
               <h2>Share Of Life</h2>
               <h3><p>Ceritakan pengalaman berharga dihidupmu </p></h3>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Share Of Life</h2>
                <h3><p>Lakukan hal terbaik untuk menumbuhkan generasi muda </p></h3>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
               <h2>Share Of Life</h2>
               <h3><p>"liburan tahun baruku terasa sangat menyenangkan" </p></h3>
